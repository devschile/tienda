...
import type { AirtableRecord, AirtableResponse } from '@/types/product';
          ...
          records: [
            {
              ...
              fields: {
                ...
                imagen: [{ url: 'https://via.placeholder.com/300x300?text=Osito' }]
              }
            },
            {
              id: 'rec2', 
              fields: {
                ...
                imagen: [{ url: 'https://via.placeholder.com/300x300?text=Unicornio' }]
              }
            }
          ]
        });
